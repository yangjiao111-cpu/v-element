...
import { E as _ } from "./Icon-BbgP-TA1.js";
import { t as B } from "./vendor-A66xrd7L.js";
import { _ as z, w as T } from "./utils-s2vBiec7.js";
const k = Symbol("BUTTON_GROUP_CTX_KEY"), E = z(e({ name: "ErButton", __name: "Button", props: { tag: { default: "button" }, type: {}, size: {}, nativeType: { default: "button" }, disabled: { type: Boolean }, loading: { type: Boolean }, icon: {}, circle: { type: Boolean }, plain: { type: Boolean }, round: { type: Boolean }, loadingIcon: {}, autofocus: { type: Boolean }, useThrottle: { type: Boolean, default: true }, throttleDuration: { default: 500 } }, emits: ["click"], setup(e2, { expose: b2, emit: v2 }) {
  ...
  const o2 = e2;
  return b(k, v({ size: g(o2.size), type: g(o2.type), disabled: g(o2.disabled) })), (e3, o3) => (i(), m("div", I, [p(e3.$slots, "default", {}, void 0, true)]));
